        ...
        <div className="res-container">
            ...
            <ul className="menu-item-list">
                ...
                menuCategories.map((c,index)=> {
                    return <RestaurantMenuCategory key={c.card.card.categoryId} data={c} show={index===indexToShow?true:false} indexToShow={indexToShow} setIndexToShow={()=>setIndexToShow(index)} />
                })}
            </ul>
